// ✅ src/components/reusable/ConfirmationModal.tsx
...
interface ConfirmationModalProps {
  ...
  title?: string;
  description?: string;
  // ✅ FIX: remove "submit" because Button variant doesn't support it
  variant?:
    | "default"
    | "destructive"
    | "outline"
    ...
    | "ghost"
    | "link";
  // ✅ OPTIONAL: if you intended "submit", use HTML button type instead
